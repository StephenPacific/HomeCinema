...
test("the stable majority excludes one slow speaker from the room target", () => {
  assert.deepEqual(
    roomTimingCohort([{ delayMs: 140 }, { delayMs: 146 }, { delayMs: 390 }]),
    { includedIndexes: [0, 1], excludedIndexes: [2], medianDelayMs: 146 }
  );
  assert.deepEqual(
